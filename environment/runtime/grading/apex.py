...
TASK_GRADING_REVISIONS = {'task_001': {'id': 'task-001-conditional-credit-effectiveness-v42',
              ...
              'basis': 'outcome-only professional request, explicit July 2 evidence cutoff, and '
                       ...
                       'ordinary accounting, forecast, commercial, policy, ordinary AP batch, and '
                       'close-tracker records without source-side accounting conclusions or '
                       'curated exception cues; separately filed, late-received conditional credit '
                       'correspondence must be reconciled by operative execution terms, both '
                       'signatures, ordinary package-release and executed-return records, the '
                       'referenced credit-memo delivery condition, document and receipt dates, '
                       'scope, and accounting effect against the earlier commercial working '
                       'records; deterministic checks cover artifact integrity and exact objective '
                       'prerequisites; an unchanged canonical template association takes the '
                       'deterministic fast path, while every edited, moved, or equivalently '
                       'relabeled numeric field receives criterion-scoped semantic association '
                       'review before credit; authority, accounting treatment, cutoff support, '
                       'source use, and action sufficiency are always semantic; no finite '
                       'row-label alias list decides reward, misleading labels and unlabeled '
                       'number dumps receive no rescue, and blank starter labels open no semantic '
                       'gate; June completeness uses practical AP, payroll, billing, and total '
                       'controls rather than hidden transaction registers; ordinary ERP statuses '
                       'remain realistic but lightly weighted; and the proposed entry follows the '
                       'existing June 1 auto-reversal by re-establishing the gross June project '
                       'balance rather than misgrading the May-to-June change as the journal to '
                       'post; a pre-cutoff vendor invoice on page 4 of an ordinary ten-invoice AP '
                       'scan batch must be matched by project, vendor, work package, PO reference, '
                       'and amount to a separate PM Commitment Detail row and reconciled to its '
                       'absence from the posted June ledger, producing a separate AP accrual and '
                       'an equal ETC-to-incurred transfer without double counting EAC or '
                       'contaminating the WIP journal; a later-filed ordinary contract-records '
                       'batch must also be reconciled to the PM commitment and AP invoice to '
                       'recognize that PO-2409-117 is already carried inside the PCO-011 '
                       'mechanical-rework cost support, so the shared $46,800 is included once '
                       'rather than restored through a second forecast overlay; the same ordinary '
                       'contract-records batch also contains a separately filed $27,000 credit '
                       'memorandum against previously billed work, while the signed agreement '
                       'assigns the other $45,000 of its $72,000 adjustment to the remaining '
                       'unbilled subcontract balance and conditions both components on delivery of '
                       'the referenced memorandum to ARM Commercial Records; the ordinary July 2 '
                       'receipt therefore requires Finance to exclude both credit components from '
                       'the June 30 close without treating the source-to-ledger difference as a '
                       'missing June posting; this same invoice is a normal cumulative '
                       'mixed-period progress bill with $46,800 gross billings, a $13,003.31 prior '
                       "draw already posted under the accounting system's internal document "
                       'number, and $33,796.69 currently due; its gross work lines allocate '
                       '$40,200 to the June field window and $6,600 to July 2, requiring the '
                       'preparer to match the prior draw, accrue only $27,196.69 of unbilled June '
                       'work, and remove both the stale prior-billing duplicate and current June '
                       'transfer from the PM forecast; this ordinary cumulative-billing and timing '
                       'evidence is carried in the invoice and vendor release rather than an '
                       'exception schedule; this deepens the existing close judgment without '
                       'changing the prompt, requested deliverable, memo topology, or required '
                       'workstreams; section-normalized scoring keeps that core recommendation, '
                       'calculation, and posting work materially above routine packaging and '
                       'source-list credit without imposing a score cap; unchanged canonical '
                       'primary fields with a conflicting numeric value fail objectively instead '
                       ...
                       'controlling association rather than a headline source citation'},
 'task_004': {'id': 'task-004-close-status-release-judgment-v14',
              ...
              'basis': 'an outcome-only business prompt and neutral two-sheet starter require '
                       ...
                       'commercial, policy, prior-close, and accounting records; the shared PM '
                       'register retains the real amounts, statuses, timing, and correspondence '
                       'but no longer exposes an inclusion flag that announces forecast treatment; '
                       'row, column, sheet, label, and ordinary unit variation are accepted; exact '
                       'amounts and formula behavior remain deterministic while edited review '
                       'status, accounting rationale, source use, ownership, and portfolio release '
                       'wording receive independent scoped semantic review; a recognized primary '
                       'recommendation cannot be rescued by a contradictory hypothetical support '
                       'row, and a clearly scoped portfolio-wide AP action can satisfy the same '
                       'cutoff action without four repetitions; an ordinary ARM-2318 invoice '
                       'exceeds the amount carried for its PO in the PM commitment detail, so the '
                       'close must transfer only the forecast overlap, recognize the residual EAC '
                       'increase, and apply the existing Controller-review threshold without any '
                       'prompt hint; portfolio-wide policy provenance is included in each scoped '
                       'source-use review without requiring repeated filenames; an ordinary '
                       'close-chat row records that the Controller already checked the ARM-2318 '
                       'lift/retest estimate and retained the excluded PCO treatment; Finance must '
                       'distinguish that completed exception review from the still-open AP, '
                       'commercial, and ordinary close-sign-off work rather than placing every '
                       'project on the same hold; this deepens the existing release judgment '
 ...
 'task_035': {'basis': 'a concise business objective and neutral working model require '
                       ...
                       'and a management recommendation without announcing the hidden difficulty; '
                       'exact magnitudes, date/project facts, and formula results retain '
 ...
 'task_068': {'basis': 'a concise executive request requires independent cross-source '
                       ...
                       'consolidation while the Vista close history, operating evidence, owner '
                       'support, Finance recovery review, forecast sensitivity, guidance cases, '
                       'signed risk register, release policy, and published range remain single '
                       'process-owned company records shared across the affected reporting tasks; '
                       'the close history contains posted originals, reversals, revisions, parked '
                       'and next-period batches, plus later June-period postings after the July 3 '
                       'controller-package cutoff, but no source-side revenue presentation effect, '
                       'EBITDA effect, branch subtotal, consolidated answer, mitigation aggregate, '
                       'stress result, or release conclusion; current operating evidence is a '
                       '48-row record population, and the action-support and Finance-review files '
                       'retain dated executed, approved, superseded, withdrawn, draft, challenged, '
                       'and sensitivity-only history rather than one-row action answers; a '
                       'preparer must apply source status and cutoff, aggregate the accepted '
                       'evidence, join the approved rate and margin bases, and distinguish the '
                       'final Finance view from same-day sensitivity work; retained earlier '
...
def _legacy_file_atomic_specs(task_id: str) -> list[tuple[str, str]]:
    ...
    if task_id == "task_004":
        ...
        specs.extend(
            (f"calculation_support__{field}", f"Calculation support {description}")
        ...
        specs.extend(
            (f"calculation_support__equation__{field}", f"Calculation support equation {description}")
            for field, description in (
        ...
        for reversal in (25, 50, 100):
            specs.extend(
                (f"sensitivity__reversal_{reversal}__{field}", f"{reversal}% WIP-reversal sensitivity {field.replace('_', ' ')}")
                for field in (
...
def _legacy_file_semantic_ids(task_id: str) -> set[str]:
    ...
    if task_id == "task_015":
        return {
            ...
            "status__circulation", "headroom__binding_covenant",
            "source__authority", "metric__leverage__status",
            "metric__fccr__status", "metric__tangible_net_worth__status",
            ...
            criterion_id for criterion_id in ids
            if criterion_id.startswith(("metric__", "calculation_support__", "sensitivity__"))
        }
    raise KeyError(task_id)
...
def _canonicalize_legacy_file_policy(task_id: str, result: dict[str, Any]) -> dict[str, Any]:
    ...
    if actual_ids != set(policy_by_id):
        raise ValueError(
            f"sample artifact rubric ids drifted for {task_id}: "
    ...
    if isinstance(review, dict):
        ...
        if reviewed != semantic_ids:
            raise ValueError(
                f"sample semantic route drifted for {task_id}: "
